...
/**
 * NormalState 클래스입니다.
 * State 인터페이스를 구현했으며, 주식 거래 정상 상태를 처리하는 클래스입니다.
 */
public class NormalState implements State{
    /** 싱글톤 인스턴스 */
    private static NormalState singleton = new NormalState();
    /**
     * NormalState 클래스의 생성자입니다.
    ...
    /**
     * NormalState의 싱글톤 인스턴스를 반환합니다.
     *
     * @return NormalState 싱글톤 인스턴스
     */
     ...
     * 잔고가 0 미만이라면 매수가 금지되고, 신용 등급이 정상 상태임을 알립니다.
     *
    ...
    public int buy(Context context) {
        ...
        context.callTransactionAlarm("현재 고객님은 주식 거래 정상 단계입니다!");
    ...
    public int sell(Context context) {
        context.callTransactionAlarm("현재 고객님은 주식 거래 정상 단계 입니다!");
        return balance + context.getStock();
    }
}
