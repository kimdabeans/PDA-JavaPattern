package Strategy;
/**
 * ActiveInvestmentTradingStrategy 클래스입니다.
 * TradingStrategy 인터페이스를 구현했으며, 적극적 투자 전략을 구현하는 클래스입니다.
...
public class ActiveInvestmentTradingStrategy implements TradingStrategy {
     ...
     * 현재 가격이 과거 가격보다 높은 경우에는 주식을 매도하고, 현재 가격이 과거 가격보다 낮은 경우에는 주식을 매수합니다.
     *
