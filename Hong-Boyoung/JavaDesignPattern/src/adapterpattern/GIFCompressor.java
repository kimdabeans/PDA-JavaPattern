...
/**
 * GIFCompressor 클래스는 AdvancedMediaCompressor 인터페이스를 구현하여 주어진 이미지를 GIF 파일로 압축합니다.
 */
public class GIFCompressor implements AdvancedMediaCompressor{
    /**
    ...
    public void compressGIF(String fileName) {
        System.out.println("Compressing to GIF file. Name: "+ fileName);
    }
}
