...
/**
 * 의류 중 아우터(Outers)를 나타내는 클래스입니다.
 *
 * 이 클래스는 {@link Clothes} 클래스를 상속하여 아우터 주문 및 결제 작업을 관리합니다.
 */
public class Outers extends Clothes {
    /**
     * 아우터 선택 및 주문을 처리하는 메서드입니다.
     *
     * 작업은 등록된 {@link ShoppingService} 인터페이스를 구현한 서비스에서 수행됩니다.
     */
    @Override
    public void selectService() {
        System.out.println("아우터 선택");
