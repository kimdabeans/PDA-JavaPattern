...
/**
 * 입금 액션을 나타내는 클래스 (ConcreteImplementor)
 *
 * @author Lee Sohyeong
 */
public class DepositAction implements BankAccountAction {

    // 클래스의 유일한 인스턴스를 클래스 내에 static 필드로 저장을 한다.
    private static final DepositAction instance = new DepositAction();
     ...
     * @return 입금 액션 인스턴스
     */
    public static DepositAction getInstance() {
        return instance;
    }
