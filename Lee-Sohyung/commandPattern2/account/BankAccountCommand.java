...
public class BankAccountCommand implements Command {
    ...
    /**
     * 명령을 수행하며, 종류에 따라 은행 계좌의 입금 또는 출금을 처리한다. (TemplateMethod)
     */
    @Override
    public void call() {
    ...
    /**
     * 명령을 취소하며, 종류에 따라 은행 계좌의 입금 또는 출금을 취소한다. (TemplateMethod)
     */
    @Override
    public void undo() {
        if (!succeeded) return;
